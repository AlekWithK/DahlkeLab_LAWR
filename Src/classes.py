...
upper_clairborne_aquifer = Aquifer(
    ...
    wb_dir = 'ShapeFiles/Aquifers/Upper_Clairborne/HUC4',
    wb_shapefiles = 'WBDHU4.shp',
    aq_shapefile = 'ShapeFiles/Aquifers/Upper_Clairborne/MERAS.shp',
    states = ['AR', 'LA', 'MS', 'TN', 'KY', 'MO', 'AL', 'GA', 'IL', 'IN', 'OK', 'TX'],
    blacklist = set()
)
...
central_valley_aquifer = Aquifer(
    ...
    wb_shapefiles = 'WBDHU4.shp',
    aq_shapefile = 'ShapeFiles/Aquifers/Central_Valley/CentralValley.shp',
    states = ['CA', 'OR'],
...
columbia_plateau_aquifer = Aquifer(
    ...
    wb_shapefiles = 'WBDHU4.shp',
    aq_shapefile = 'ShapeFiles/Aquifers/Columbia_Plateau/ColuPlat.shp',
...
high_plains_aquifer = Aquifer(
    ...
    wb_shapefiles = 'WBDHU4.shp',
    aq_shapefile = 'ShapeFiles/Aquifers/High_Plains/HighPlains.shp',
